...
function Library:SetGlass(Enabled, Transparency)
    ...
    local boxT = Library.GlassEnabled and math.clamp(innerT * 0.35, 0, 0.22) or 0
    pcall(function()
        if Library.WindowOuter then
            Library.WindowOuter.BackgroundColor3 = Library.BackgroundColor
        ...
        if Library.GlassEnabled and Library.UseBlur ~= false then
            Library.UseBlur = true
            Library.BlurSize = math.clamp(Library.BlurSize or 28, 12, 56)
            pcall(function() Library:UpdateBlur() end)
        end
    end)
end
...
-- LuaX Linoria stable glass build note
-- LuaX Linoria stable glass build note
-- LuaX Linoria stable glass build note
-- LuaX Linoria stable glass build note
-- LuaX Linoria stable glass build note
